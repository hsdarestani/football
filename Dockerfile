...
RUN sed -i 's#</head>#<link rel="stylesheet" href="/v8-de.css?v=8-de"></head>#' /usr/share/nginx/html/index.html \
 && sed -i 's#</body>#<script src="/v7-fixes.js?v=8-de"></script></body>#' /usr/share/nginx/html/index.html
EXPOSE 80
